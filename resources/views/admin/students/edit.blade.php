...
<div class="py-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <h4 class="fw-bold mb-0">Edit {{ $student->name }}</h4>
    </div>
            ...
            <form method="POST" action="{{ route('admin.students.update', $student) }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="birth_date" class="form-control @error('birth_date') is-invalid @enderror" value="{{ old('birth_date', optional($student->birth_date)->format('Y-m-d')) }}">
